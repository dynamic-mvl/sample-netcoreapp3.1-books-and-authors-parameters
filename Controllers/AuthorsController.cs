...
namespace BookAuthors.Controllers
{
    public class AuthorsController : Controller
    {
        ...
        public AuthorsController(ApplicationDbContext context, ICompositeViewEngine viewEngine)
        {
        ...
        // In this example we need to specifically use a POST method because our 
        // ListItemParameters object will contain additional data which could not 
        // fit in the GET query string.
